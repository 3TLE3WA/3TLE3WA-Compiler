...
public:
   ...
   */
    ...
    virtual std::any visitTranslationUnit(SysYParser::TranslationUnitContext *context) = 0;

    virtual std::any visitExternalDeclaration(SysYParser::ExternalDeclarationContext *context) = 0;
    ...
    virtual std::any visitBlockItemList(SysYParser::BlockItemListContext *context) = 0;
    ...
    virtual std::any visitAssignOp(SysYParser::AssignOpContext *context) = 0;
    ...
    virtual std::any visitWhileLoop(SysYParser::WhileLoopContext *context) = 0;
    ...
    virtual std::any visitNumber1(SysYParser::Number1Context *context) = 0;

    virtual std::any visitNumber2(SysYParser::Number2Context *context) = 0;
    ...
    virtual std::any visitCondExp(SysYParser::CondExpContext *context) = 0;
